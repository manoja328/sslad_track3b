...
def main():
    ...
    from frcnn.initialize import get_fpn_mod2, get_fpn, get_fpn_mod , get_res101_FRCNN , get_fpn_frozen
    ...
    #concat all at once
    train_datasets = AvalancheConcatDataset(train_datasets)

    print(f"-------->  offline train {len(train_datasets)} val {len(val_datasets)} ")
